<div align="center">
  ...
  <p align="center">
    Whether you're a seasoned developer or just starting your journey, this event is designed for YOU. This is a fun space to experiment with new technologies, learn from your peers, and grow your skills—all while having a great time!
  </p>
</div>

## About the event

Join in to try the frameworks/patterns you’ve always been curious about, learn by doing, connect with awesome peers across teams, build confidence through friendly competition — and most importantly, have fun along the way. Don’t be afraid to fail — that’s how we learn!

> We welcome all skill levels. Partial solutions, learning attempts, and "I tried something new" are all celebrated here.
...
- 🟢 _GraphQL Fundamentals_
- 🟢 _Clean Architecture Basics_
- 🟢 _Performance Profiling_
- 🟢 _Testing Legacy Code_
- 🟢 _AI-assisted Development_
