...
| US4 Lifecycle / transitions | **P1-05** Carrier-rejected path + tests |
| US5 Aggregate KPIs | **P1-04** `GET /notifications/kpis` + SMS KPIs UI |
...
| P1-05 | **Done** | [p1-us4-carrier-rejected-path.md](p1-us4-carrier-rejected-path.md) | Queue → Send-to-carrier → Carrier-rejected (sim `090909094`) → retry; tests |
| P1-04 | **Done** | [p1-us5-cost-aggregates-kpis.md](p1-us5-cost-aggregates-kpis.md) | US5 KPIs API + `/kpis` UI |
